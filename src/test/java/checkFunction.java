...
public class checkFunction {
    ...
    public void 괄호부터_먼저_계산되는가() {
        assertThat(Calculator.firstBracket(new ArrayList<>(Arrays.asList(new String[]{"(", "1", "+", "3", ")", "*", "4"}))), is(new ArrayList<>(Arrays.asList(new String[]{"4", "*", "4"}))));
        assertThat(Calculator.firstBracket(new ArrayList<>(Arrays.asList(new String[]{"(", "1", "+", "3", "*", "5", ")", "*", "4"}))), is(new ArrayList<>(Arrays.asList(new String[]{"16", "*", "4"}))));
    }
